...
echo "Commands like 'python' and 'pip' now refer to the ones inside the venv."

# --- 3. Dynamic Dependency Preparation (NEW) ---
echo "Exporting fresh dependencies from Poetry..."
# This ensures requirements.txt reflects the current poetry.lock
...
echo "Filtering dependencies for Termux..."
...
echo "Installing filtered Python packages via pip..."
pip install \
    --no-deps \
    --no-cache-dir \
    --prefer-binary \
...
echo "Termux setup complete. Venv is active."