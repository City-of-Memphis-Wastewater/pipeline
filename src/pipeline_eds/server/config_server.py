# src/pipeline_eds/server/config_server.py
...
from pipeline_eds.server.web_utils import find_open_port
...
async def serve_config_modal_html(request: Request):
    ...
    try:
        ...
        html_content = resources.read_text('pipeline_eds.interface.web_gui.templates', 'config_modal.html')
