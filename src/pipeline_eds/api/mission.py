...
class MissionClient:
    ...
    def login_and_retrieve_analog_csv_bytes(device_name:str=None, device_id:int = None, start_date: int=None, end_date: int=None)->bytes:
        ...
        """
        typer.echo("Running: pipeline_eds.api.mission.login_and_retrieve_analog_csv_bytes()...")
...
def demo_retrieve_analog_data_table():
    ...
    It is better to use 
    """
    typer.echo("Running: pipeline_eds.api.mission.demo_retrieve_analog_data_table()...")
    typer.echo("Running: Calling 123scada.com using the Mission Client ...")
    party_name = "Mission"
    device_id = 22158
