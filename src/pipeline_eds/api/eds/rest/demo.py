# src/pipeline_eds/eds/rest/demo.py
...
def demo_eds_webplot_point_live():
    ...
    from pipeline_eds.queriesmanager import QueriesManager, load_query_rows_from_csv_files, group_queries_by_col
    from workspaces.eds_to_rjn.code import collector
    from pipeline_eds.plotbuffer import PlotBuffer
    from pipeline_eds import gui_starlette_msgspec_plotly
...
if __name__ == "__main__":
    ...
    if cmd == "demo-live":
        ...
        print("Usage options: \n" 
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-point-export \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-tabular-export \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-live \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-live-alt \n"  
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-trend \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-plot-live \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-webplot-live \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-plot-trend \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo demo-db \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo ping \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo license \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo export-graphics \n"
        "poetry run python -m pipeline_eds.api.eds.rest.demo access-workspace")