...
if __name__ == "__main__":
    ...
    if cmd == "demo-live":
        ...
        print("Usage options: \n" 
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-point-export \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-tabular-export \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-live \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-live-alt \n"  
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-trend \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-plot-live \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-webplot-live \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-plot-trend \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo demo-db \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo ping \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo license \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo export-graphics \n"
        "uv run python -m pipeline_eds.api.eds.rest.demo access-workspace")